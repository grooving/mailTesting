# Generated by Django 2.1.7 on 2019-04-18 12:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('es', 'es'), ('en', 'en')], default='en', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastModification', models.DateTimeField(auto_now=True)),
                ('isHidden', models.BooleanField(default=False)),
                ('days', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=10), null=True, size=None)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastModification', models.DateTimeField(auto_now=True)),
                ('isHidden', models.BooleanField(default=False)),
                ('minimumPrice', models.DecimalField(decimal_places=2, max_digits=20, validators=[django.core.validators.MinValueValidator(Decimal('1.0'))])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastModification', models.DateTimeField(auto_now=True)),
                ('isHidden', models.BooleanField(default=False)),
                ('priceHour', models.DecimalField(decimal_places=2, max_digits=20, validators=[django.core.validators.MinValueValidator(Decimal('2.0'))])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'PENDING'), ('NEGOTIATION', 'NEGOTIATION'), ('CONTRACT_MADE', 'CONTRACT_MADE'), ('WITHDRAWN', 'WITHDRAWN'), ('REJECTED', 'REJECTED'), ('CANCELLED_ARTIST', 'CANCELLED_ARTIST'), ('CANCELLED_CUSTOMER', 'CANCELLED_CUSTOMER'), ('PAYMENT_MADE', 'PAYMENT_MADE')], default='PENDING', max_length=50)),
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=20, validators=[django.core.validators.MinValueValidator(Decimal('1.0'))])),
                ('currency', models.CharField(default='EUR', max_length=3)),
                ('paymentCode', models.CharField(blank=True, max_length=10, null=True, unique=True)),
                ...
                ('chat', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='offer', to='emailTesting.Chat')),
                ('eventLocation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='offers', to='emailTesting.EventLocation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artisticName', models.CharField(blank=True, max_length=140, null=True, unique=True)),
                ('artist', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='portfolio', to='emailTesting.Artist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastModification', models.DateTimeField(auto_now=True)),
                ('isHidden', models.BooleanField(default=False)),
                ('type', models.CharField(choices=[('PHOTO', 'PHOTO'), ('VIDEO', 'VIDEO'), ('AUDIO', 'AUDIO'), ('TWITTER', 'TWITTER'), ('INSTAGRAM', 'INSTAGRAM'), ('MEMBER', 'MEMBER')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastModification', models.DateTimeField(auto_now=True)),
                ('isHidden', models.BooleanField(default=False)),
                ('minimumPrice', models.DecimalField(decimal_places=2, default=0.0, max_digits=20, validators=[django.core.validators.MinValueValidator(Decimal('1.0'))])),
                ('currency', models.CharField(default='EUR', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastModification', models.DateTimeField(auto_now=True)),
                ('isHidden', models.BooleanField(default=False)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=20, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.3'))])),
                ('braintree_id', models.CharField(blank=True, max_length=70, null=True)),
        ...
        migrations.AddField(
            model_name='paymentpackage',
            name='portfolio',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='paymentPackages', to='emailTesting.Portfolio'),
        ),
        migrations.AddField(
            model_name='offer',
            name='paymentPackage',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='offers', to='emailTesting.PaymentPackage'),
        ),
        migrations.AddField(
            model_name='offer',
            name='rating',
